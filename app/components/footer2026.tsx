  ...
  return (
    <footer className="w-full bg-[#131415]">
      ...
      <div className={SITE_CONTAINER}>
        ...
        <div className={`${TEXT_10} flex flex-col items-start gap-8 text-left`}>
          <h2 className="m-0 w-full text-[28px] font-semibold leading-[1.15] text-white sm:text-[32px] lg:text-[36px]">
            For new projects,{" "}
            <span className="whitespace-nowrap">RPG sessions</span>
            <br className="hidden lg:block" />
            {" "}or just a good design chat, reach out.
          </h2>
      ...
      <div className="border-t border-white/10">
        <div className={SITE_CONTAINER}>
          <div className={GRID_12}>
          <div className={`${TEXT_10} flex h-20 flex-col items-start justify-center gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6`}>
